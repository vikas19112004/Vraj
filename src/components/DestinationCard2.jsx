export default function DestinationCard2({cardImg, cardTitle, cardContent}) {
    return(
        <div className="xl:w-[80%] lg:w-[100%] rounded-4xl shadaow-lg shadow-gray-300 bg-sky-200 flex flex-row items-center justify-between px-[2rem] gap-[1.5rem] py-[2rem] self-start max-[450px]:flex-col max-[450px]:self-center max-[450px]:w-[100%] max-[450px]:p-[1rem]">
