...
const Navbar = () => {
  return (
    <>
      <nav className=" navbar text-gray-800 px-[10%] py-3 flex justify-between items-center border-b-[2px] border-solid border-pink-700 bg-[url(src/assets/Header-image.jpg)] bg-contain sticky z-10 w-[100%] top-[0rem] max-[450px]:px-[4%]">
        <Link to="/" className="text-4xl text-blue-200 font-bold"><img src="src/assets/Logo.png" alt="logo" className="w-[13rem] brightness-200 max-[450px]:w-[8rem]" /></Link>
